...
export function WalletAuthButton() {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const message = createWalletChallenge(address)
      ...
      await authenticateWithWallet(address, message, signature)
  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <>
          {/* Official MetaMask fox — scraped from MetaMask/metamask-extension */}
          <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
